...
echo "=========================================="
echo " DNS Changer — Luppo Package Builder"
echo "=========================================="

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
export DNS_CHANGER_SRC_DIR="${SCRIPT_DIR}"
cd "${SCRIPT_DIR}"
...
LUPPO_FILE=$(find . /var/luppo /tmp -name "dns-changer-*.luppo" 2>/dev/null | head -n 1 || true)
